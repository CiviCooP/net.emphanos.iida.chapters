...
class CRM_Chapters_Page_UpdateAllContacts extends CRM_Core_Page {
  ...
  function run() {
    ...
    $runner = new CRM_Queue_Runner(array(
      ...
      'onEnd' => array('CRM_Chapters_Page_UpdateAllContacts', 'onEnd'), //method which is called as soon as the queue is finished
      'onEndUrl' => CRM_Utils_System::url('civicrm/contact/view', 'reset=1&selectedChild=tab_automatch_chapters&cid='.$cid, true, null, false), //go to page after all tasks are finished
    ));
